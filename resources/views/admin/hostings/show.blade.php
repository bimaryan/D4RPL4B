...
<div class="flex items-center gap-3 mb-6">
    ...
    <a href="{{ $hosting->domain_url }}" target="_blank" class="hidden sm:inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500 text-white text-[13px] font-medium hover:bg-emerald-600"><i class="fa-solid fa-arrow-up-right-from-square text-[11px]"></i> Buka Site</a>
...
<div class="bg-white border border-[#E8DFD1] rounded-xl overflow-hidden">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 p-6">
        ...
        <a href="{{ route('hostings.database', $hosting->hash_id) }}" class="group border border-[#E8DFD1] rounded-xl p-5 hover:border-[#11100F] hover:shadow-[0_8px_24px_rgba(0,0,0,0.06)] transition text-center">
            <div class="w-12 h-12 rounded-xl bg-[#FFF0E6] border border-[#F2C0AA] flex items-center justify-center mx-auto text-[#E84E0F] group-hover:scale-105 transition"><i class="fa-solid fa-database text-[18px]"></i></div>
        ...
        <a href="{{ route('hostings.ssl', $hosting->hash_id) }}" class="group border border-[#E8DFD1] rounded-xl p-5 hover:border-emerald-500 hover:shadow-[0_8px_24px_rgba(0,0,0,0.06)] transition text-center">
            <div class="w-12 h-12 rounded-xl bg-emerald-50 border border-emerald-200 flex items-center justify-center mx-auto text-emerald-600 group-hover:scale-105 transition"><i class="fa-solid fa-shield-halved text-[18px]"></i></div>
            <div class="font-medium text-[13px] mt-3">SSL</div>
            <div class="text-[11px] text-emerald-700">Auto Let's Encrypt</div>
        </a>
        <a href="{{ route('hostings.terminal', $hosting->hash_id) }}" class="group border border-[#E8DFD1] rounded-xl p-5 hover:border-[#11100F] hover:shadow-[0_8px_24px_rgba(0,0,0,0.06)] transition text-center">
            <div class="w-12 h-12 rounded-xl bg-[#F6F5F1] border border-[#E8DFD1] flex items-center justify-center mx-auto text-[#11100F] group-hover:scale-105 transition"><i class="fa-solid fa-terminal text-[18px]"></i></div>
            <div class="font-medium text-[13px] mt-3">Terminal</div>
            <div class="text-[11px] text-[#7A7670]">Web SSH</div>
        </a>
        <a href="{{ route('hostings.metrics', $hosting->hash_id) }}" class="group border border-[#E8DFD1] rounded-xl p-5 hover:border-[#11100F] hover:shadow-[0_8px_24px_rgba(0,0,0,0.06)] transition text-center">
            <div class="w-12 h-12 rounded-xl bg-[#F6F5F1] border border-[#E8DFD1] flex items-center justify-center mx-auto text-[#11100F] group-hover:scale-105 transition"><i class="fa-solid fa-chart-line text-[18px]"></i></div>
            <div class="font-medium text-[13px] mt-3">Metrics</div>
            <div class="text-[11px] text-[#7A7670]">{{ $usage['human'] }} used</div>
        </a>
        <a href="{{ route('hostings.cron', $hosting->hash_id) }}" class="group border border-[#E8DFD1] rounded-xl p-5 hover:border-[#11100F] hover:shadow-[0_8px_24px_rgba(0,0,0,0.06)] transition text-center">
            <div class="w-12 h-12 rounded-xl bg-[#F6F5F1] border border-[#E8DFD1] flex items-center justify-center mx-auto text-[#11100F] group-hover:scale-105 transition"><i class="fa-solid fa-clock text-[18px]"></i></div>
            <div class="font-medium text-[13px] mt-3">Cron Jobs</div>
            <div class="text-[11px] text-[#7A7670]">Scheduler</div>
        </a>
        <a href="{{ route('hostings.backup', $hosting->hash_id) }}" class="group border border-[#E8DFD1] rounded-xl p-5 hover:border-[#11100F] hover:shadow-[0_8px_24px_rgba(0,0,0,0.06)] transition text-center">
            <div class="w-12 h-12 rounded-xl bg-[#F6F5F1] border border-[#E8DFD1] flex items-center justify-center mx-auto text-[#11100F] group-hover:scale-105 transition"><i class="fa-solid fa-box-open text-[18px]"></i></div>
